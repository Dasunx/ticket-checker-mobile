  ...
  static ThemeData themeData(bool isDarkTheme, BuildContext context) {
    return ThemeData(
        ...
        floatingActionButtonTheme: FloatingActionButtonThemeData(
          ...
          splashColor: isDarkTheme ? Colors.red : Color(0xffA8DAB5),
          focusColor: isDarkTheme ? Colors.red : Color(0xffA8DAB5),
          hoverColor: isDarkTheme ? Colors.red : Color(0xffA8DAB5),
        ),
        cardTheme: CardTheme(
        ...
        highlightColor: isDarkTheme ? Colors.red : Color(0xffA8DAB5),
